...
async def create_config(request: CustomerConfigCreate) -> CustomerConfigResponse:
    ...
    Args:
        request: Customer configuration data

    Returns:
        Created configuration (without sensitive fields)

    Raises:
        HTTPException: 409 if customer already exists
    """
...
async def list_configs() -> CustomerConfigListResponse:
    ...
    Returns:
        List of all configurations (without sensitive fields)
    """
...
async def get_config(customer_id: str) -> CustomerConfigResponse:
    ...
    Returns:
        Customer configuration (without sensitive fields)
...
async def update_config(
    ...
    Returns:
        Updated configuration (without sensitive fields)
